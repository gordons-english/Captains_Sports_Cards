    ...
    <header class="bg-white shadow-sm border-b border-gray-200">
        <div class="container mx-auto px-4 py-8 text-center">
            ...
            <div class="mt-6 text-left max-w-3xl mx-auto">
                ...
                <!-- HOW IT WORKS BOX -->
                <div class="p-6 bg-blue-50 rounded-lg border border-blue-100 shadow-sm mb-6">
                    <h3 class="font-bold text-blue-800 mb-3 border-b border-blue-200 pb-2 text-lg"><i class="fa-solid fa-circle-info mr-2"></i>How It Works:</h3>
                    <ul class="text-sm text-blue-900 space-y-3">
                        <li class="flex items-start"><i class="fa-solid fa-images mt-1 mr-3 opacity-70"></i> <div><strong>One Image = One Group:</strong> You are purchasing the entire group of cards shown. We do not pick individual cards.</div></li>
                        <li class="flex items-start"><i class="fa-solid fa-folder-open mt-1 mr-3 opacity-70"></i> <div><strong>Large Lots:</strong> Specific folders containing many images are called "Lots" (e.g., Lot 1). The price for the entire lot is listed on the folder name.</div></li>
                        <li class="flex items-start"><i class="fa-solid fa-tag mt-1 mr-3 opacity-70"></i> <div><strong>Transparent Pricing:</strong> The price for a Group is listed in the filename (e.g., <code>..._25.00.jpg</code>).</div></li>
                        <li class="flex items-start"><i class="fa-solid fa-calculator mt-1 mr-3 opacity-70"></i> <div><strong>Click Add:</strong> Use the Add button to put the Group in your cart.</div></li>
                    </ul>
                </div>
                ...
                <div class="p-6 bg-gray-50 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <ol class="text-sm text-gray-700 space-y-2 list-decimal list-inside">
                        ...
                        <li><strong>View Groups & Lots:</strong> Each image represents a complete <strong>Group</strong> of cards. Large collections are organized into <strong>Lot</strong> folders.</li>
                        ...
                        <li><strong>Check Price:</strong> The price for the entire group is listed directly in the file name.</li>
